      ...
      <div class="container">
        <?php
            ...
            if(isset($_POST['insert'])){
              ...
              echo "<div class='table-container'><form method='post' action = 'data_Add.php'>
                      <h2>Input NIM dan Prodi Mahasiswa</h2><br>
                      <table class='custom-table'><tr><th>Nama Mahasiswa</th><th>Nim</th><th>Prodi</th></tr>";
              ...
              foreach ($add as $id) {
                  $sql_nama = "SELECT u.nama, mhs.NIM, mhs.prodi FROM users u INNER JOIN mahasiswa mhs ON u.userID = mhs.userID WHERE mhs.userID = '$id'";
                  ...
                  echo "<tr><td><input type='text' name='nama' value='$nama' disabled></td>
                          ...
                          <td><input type='text' value='$prodi' disabled></td>
                          <input type='hidden' name='prodi[$id]' value='$prodi'>
                          <input type='hidden' name='prosesAdd[]' value='$id'></tr>";
                  $nim++;
  
              }
              echo "</table><button type='submit' name='submitAdd' class='btn btn-primary' style='margin-left: 80%; margin-top: 10px'>Add</button></form>";
  
            }else{
              echo "<script>
              alert('Tidak Ada Mahasiswa Baru');
